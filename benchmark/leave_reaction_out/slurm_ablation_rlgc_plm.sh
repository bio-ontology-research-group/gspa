...
#SBATCH --mem=12G
#SBATCH -t 24:00:00
#SBATCH -J lro_rlgc_plm
#SBATCH -o /data/hohndor/gspa/proteomes/bench_ecoli/leave_reaction_out/logs/lro_plm_%A_%a.out
#SBATCH -e /data/hohndor/gspa/proteomes/bench_ecoli/leave_reaction_out/logs/lro_plm_%A_%a.err
# Usage: sbatch --array=0-4 slurm_ablation_rlgc_plm.sh <track A|B>
...
OUT=$LRO/runs_rlgc_plm/track_${TRACK}/shard_${ID}
mkdir -p $OUT $LRO/logs

echo "== PLM track=$TRACK shard=$ID start=$START end=$END =="
date
